...
slug: auth-and-authorization/cloud-authentication
createdAt: Fri Jul 28 2023 09:10:28 GMT+0000 (Coordinated Universal Time)
updatedAt: Wed Oct 16 2024 21:30:02 GMT+0000 (Coordinated Universal Time)
---
...
<Info>
If you want to use Ditto in an air-gapped environment that is entirely offline or on‑premise, contact Ditto Customer Engineering. (See [Contact Us](docId\:n4CiVTbQAL1SmgjNO8aM8))
</Info>

<Steps>
  <Step title="Create Portal App">
    From the <a href="https://portal.ditto.live" target="_blank">portal</a>, create your app and get your access credentials required for peer-to-peer offline sync. (See [Getting Playground Token Credentials](docId\:U214QhYYMCxbV9jnamRFH))&#x20;
  </Step>
  <Step title="Initialize Ditto in Your Code">
    In the top-most scope of your codebase, set up and initialize Ditto and configure your app to use the `onlinePlayground` for testing.
...
### When should you call **ditto.auth.login**?[​](https://deploy-preview-643--shiny-croquembouche-15669a.netlify.app/ios/common/security/authentication#when-should-you-call-dittoauthlogin)
...
...log in, skip the next section, and proceed to the part titled <a href="#register-auth0">Register your app with Auth0</a>.
...
**<p id="register-auth0">Register your app with Auth0</p>**
