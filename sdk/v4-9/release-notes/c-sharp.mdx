...
<Icon icon="rotate-reverse"iconType="solid" horizontal /> **Changed:** Upgraded from .NET 6 to .NET 8. (#13288)



<Icon icon="screwdriver-wrench"iconType="solid" horizontal /> **Fixed:** DittoAttachmentFetcher.Dispose() would not cancel the onFetchEvent callbacks. (#13859)



<Icon icon="exclamation"iconType="solid" horizontal /><Icon icon="bin-recycle"iconType="solid" horizontal /> **Removed:** experimental DittoBus APIs. (#13741)
