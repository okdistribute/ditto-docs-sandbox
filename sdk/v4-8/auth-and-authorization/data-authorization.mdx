...
<Info>
  Permissions must be written using the legacy query syntax and not DQL. For more see [Query Syntax (Legacy)](/v4-8/auth-and-authorization/data-authorization#Pw82J_oFrBgM-27WMrKJm).
</Info>
