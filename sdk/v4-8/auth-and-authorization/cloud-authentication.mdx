...
<Steps>
    <Step>
    If you want to use Ditto in an air-gapped environment that is entirely offline or on‑premise, contact Ditto Customer Engineering. (See [Contact Us](/sdk/v4-8/auth-and-authorization/cloud-authentication#n4CiVTbQAL1SmgjNO8aM8))
    </Step>
    <Step>
