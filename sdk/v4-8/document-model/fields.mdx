...
For complete naming rules, see [IDs, Paths, Strings, and Keywords](/sdk/v4-8/document-model/fields#4Y_JMJedQeq0-0uDNcJcQ).
...
Each data type contains two distinct components: a merge behavior and a scalar value to store. (See [Data-Handling Essentials](/sdk/v4-8/document-model/fields#Z6tbFllqieU_CtkJR845E))
...
<Frame>
  <img src="/images/v4.8/doc-model.webp"/>
</Frame>
