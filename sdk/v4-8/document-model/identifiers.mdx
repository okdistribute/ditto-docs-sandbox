...
| ---------------------------- | --------------------------------------------------------------------------------------------------------- |
| **Customizable Identifier:** | If preferred, you can customize the \_id as a string or JSON‑object. (See [Custom Document Identifier](/v4-8/document-model/identifiers#custom-document-identifier)) |
