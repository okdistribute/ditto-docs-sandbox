...
<Info>
* To get your access credentials, see [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials).
...
<Steps>
 ...
 code .
  ```
   ...
   <Step >
   In line 14 of the index.ts file, replace 'YOUR\_APP\_ID' and 'YOUR\_TOKEN' with your app ID and playground token. (See [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials))
  ```bash bash
 code .
  ```
  </Step>
