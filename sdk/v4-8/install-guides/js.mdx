...
<Info>
  For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials) . For an introduction to authentication in Ditto, see _Security_ > [Cloud Authentication](/sdk/v4-8/auth-and-authorization/cloud-authentication).
</Info>
