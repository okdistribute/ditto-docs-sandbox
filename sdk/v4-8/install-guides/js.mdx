...
<Steps>
  <Step>
    [Prerequisites](/ab-redirect-url?docId=yXSJHOqliSNbLUVUYOcSa&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=sb-Fz): Confirm that you meet the minimum requirements.
  </Step>
  <Step>
  [Install Dependencies](/ab-redirect-url?docId=yXSJHOqliSNbLUVUYOcSa&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=i_i6q): Add the `ditto` package to your environment.
  </Step>
  <Step>
[Integrate Ditto](/ab-redirect-url?docId=yXSJHOqliSNbLUVUYOcSa&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=Ajrfc): Import and initialize Ditto in your app.
  </Step>
  <Step>
[Run Ditto](/ab-redirect-url?docId=yXSJHOqliSNbLUVUYOcSa&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=s71_W): Authenticate with the Big Peer and start syncing offline.
  </Step>
...
<Info>
  For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](/ab-redirect-url?docId=U214QhYYMCxbV9jnamRFH&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=) . For an introduction to authentication in Ditto, see _Security_ > [Cloud Authentication](/ab-redirect-url?docId=D0B4xrfN45yeM15qCYcOb&isHosted=true&queryTemplate=&shareableToken=&hostName=docs.ditto.live&docAnchorId=).
</Info>
