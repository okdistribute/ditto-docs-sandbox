...
description: "Welcome to the Flutter Quickstart Guide! This guide will help you clone, set up, and run the Ditto Demo Flutter Application from a public GitHub repository."
---



By the end of this quickstart, you will have successfully run the Ditto Task Application on either iOS, Android, or both, and will be able to sync data without needing an internet connection.
