...
3. Right-click any row in the list, and then select **Add Row** from the menu.
  <Info>
For instructions on configuring permissions for your app, see [Cloud Authentication](#cloud-authentication).
</Info>
...
For more information, contact Ditto. (See [Contact Us](https://support.ditto.live/hc/en-us))
...
<Info>
For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](/cloud/portal/getting-sdk-connection-details)
</Info>
