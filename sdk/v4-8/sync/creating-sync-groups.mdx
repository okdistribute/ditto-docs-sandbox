...
<Frame>
  <img src="/images/v4.8/image-8.png"/>
</Frame>
...
To enforce access controls by group, for instance, two groups of devices, each accessing different datasets, use Ditto's permissions system. (See [Data Authorization](/sdk/v4-8/auth-and-authorization/data-authorization))
...
```kotlin Kotlin
val transportConfig = ditto.transportConfig
