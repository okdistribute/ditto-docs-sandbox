...
For an overview of the different CRDTs that Ditto offers, see [REGISTER](/sdk/v4-8/data-types/register), [MAP](/sdk/v4-8/data-types/map), and [ATTACHMENT](/sdk/v4-8/data-types/attachment).
