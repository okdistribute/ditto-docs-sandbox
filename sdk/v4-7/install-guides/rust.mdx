...
<Info>
For a complete overview of the platforms, transports, and devices, see the [Rust Compatibility Map](../compatibility/compatibility).
</Info>
...
<Step>
Visit the <a href="/sdk/v4-7/compatibility/rust" target="_blank">Rust Compatibility Map page</a> to find the Rust Toolchain version you need based on the SDK version you chose. For SDK version 4.8.0, you should use Rust `1.74.1`.
</Step>
