...
<Info>
  For a complete overview of the platforms, transports, and devices the JavaScript SDK supports, select **Node.js** from the [Directory of Compatibility Maps](/sdk/v4-7/compatibility/compatibility).
</Info>
...
<Info>
* To get your access credentials, see [Getting Playground Token Credentials](/sdk/v4-7/getting-started/sync-credentials).
...
<Steps>
 ...
 code .
  ```
   ...
   <Step >
   In line 14 of the index.ts file, replace 'YOUR\_APP\_ID' and 'YOUR\_TOKEN' with your app ID and playground token. (See [Getting Playground Token Credentials](/sdk/v4-7/getting-started/sync-credentials)﻿)
  ```bash bash
 code .
  ```
  </Step>
...
node index.js
  ...
  <Step>
  If you want to observe your changes sync with the cloud-optional deployment, the Big Peer, open the data browser in the [Ditto portal](https://portal.ditto.live/ "Ditto portal").
  </Step>
</Steps>
