...
<Info>
Ditto does *not* support nesting documents within documents. Instead, opt for a foreign-key relationship by referencing the document ID. For more information, see [Relationships](/sdk/v4-7/document-model/relationships).
</Info>
...
- In an UPDATE operation — If the MAP does not exist, create it. (See [UPDATE](/sdk/v4-7/crud/update))
