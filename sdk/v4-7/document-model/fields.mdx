...
Each data type contains two distinct components: a merge behavior and a scalar value to store. (See [Data-Handling Essentials](/sdk/v4-7/basic/data-handling-essentials))
