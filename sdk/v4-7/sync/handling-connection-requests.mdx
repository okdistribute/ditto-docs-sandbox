...
description: "This article provides concepts and step-by-step instructions for how to use the `connectionRequestHandler` API method within your app logic to enable end-user functionality of intercepting and managing new peer connections advertised in the mesh."
---
...
- Peer metadata — The information provided by the end user associated with the peer making the request. (For more information on peer metadata, see [Using Mesh Presence](/sdk/v4-7/sync/using-mesh-presence))
