...
Rather, you manually enable peer-to-peer connections using `EnableAllPeerToPeer()`. (See [Enabling and Disabling Transports](/sdk/v4-7/sync/customizing-transport-configurations#enabling-and-disabling-transports))
</Info>
