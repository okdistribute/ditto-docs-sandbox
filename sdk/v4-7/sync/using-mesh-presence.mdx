...
The identity server metadata is set during the See [End-User Access>Setting Identity Server User Metadata](/sdk/v4-7/security/authentication) for specifics.
