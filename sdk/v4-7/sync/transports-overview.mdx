...
To enforce access controls by group, for instance, two groups of devices, each accessing different datasets, use Ditto's permissions system. (See [Data Authorization](/sdk/v4-7/security/authentication))
...
transportConfig.global.syncGroup = 1234U
