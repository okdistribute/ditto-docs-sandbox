---
title: .NET (C#) MAUI Quickstart
sidebarTitle: .NET (C#) MAUI
...
Ditto’s .NET MAUI Quickstart supports **iOS** and **Android**. Before getting started, ensure you
have the following:
- [Git](https://git-scm.com/) installed on your machine
- [.NET 9 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/9.0) installed on your machine
- .NET MAUI workload installed on your machine. Open a terminal and run:
    ```shell
