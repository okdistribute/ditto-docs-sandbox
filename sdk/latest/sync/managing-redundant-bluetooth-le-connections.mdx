...
- [Default Ditto Behavior](./managing-redundant-bluetooth-le-connections#default-ditto-behavior)
- [Considerations by Mesh Size](./managing-redundant-bluetooth-le-connections#considerations-by-mesh-size)
- [Enabling Redundant Connections](./managing-redundant-bluetooth-le-connections#enabling-redundant-connections)
