---
title : Redundant Bluetooth LE Connections
description: "This article explains how Ditto manages redundant Bluetooth Low Energy (LE) connections within the mesh network by default, the tradeoffs with mesh size in mind, and how to deviate from this default behavior so you can ensure continuous sync uptime in your mesh."
icon: bluetooth
---
