...
Considering this, when managing collections of data that have concurrent editors, opt for a `MAP` instead, which effectively functions as a set, more commonly known as an *associative array. *For more information, see [MAP](./map).
