...
If you're looking to get started quickly with an existing app we recommend following the [Flutter beta Quick Start](/flutter/quick-start).
...
- [ ] Ditto Portal account with a Ditto App (see [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials))
...
<Step>
Navigate to your application and obtain the App ID and Playground Token. (See [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials) for details)
</Step>
...
- Contact the Ditto team through [Contact Us](/support)
