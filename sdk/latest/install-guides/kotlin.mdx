...
<Step>
Replace `YOUR_APP_ID` and `YOUR_PLAYGROUND_TOKEN` with your access credentials available from the portal. (See [Getting Playground Token Credentials](/cloud/portal/getting-playground-token-credentials) )
</Step>
</Steps>
