...
- [ ] Ditto Portal account with a Ditto Application (see [Getting SDK Connection Details](/cloud/portal/getting-sdk-connection-details))
...
2. Navigate to your application and obtain the App ID and Playground Token (see [Getting SDK Connection Details](/cloud/portal/getting-sdk-connection-details) for more details)
