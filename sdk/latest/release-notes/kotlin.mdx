...
<Icon icon="triangle-exclamation"iconType="solid" horizontal /> **Deprecated:** DittoBluetoothLeConfig.maxOutgoing. This value can now be configured using the mesh\_chooser\_max\_active\_ble\_clients system parameter. See docs for details: [Using Alter System](../sync/using-alter-system.mdx). (#12320)
