...
<Steps>
    <Step>
    If you want to use Ditto in an air-gapped environment that is entirely offline or on‑premise, contact Ditto Customer Engineering. (See [Contact Us](/support/contact-us))
    </Step>
    <Step>
    From the [portal](https://portal.ditto.live/ "portal"), create your app and get your access credentials required for peer-to-peer offline sync. (See [Getting Playground Token Credentials](../../../cloud/portal/getting-playground-token-credentials))
...
<Info>
Please be sure that this endpoint is not behind a firewall or VPN. If you cannot get around this requirement [contact us](/support/contact-us).
</Info>