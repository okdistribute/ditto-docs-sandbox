...
For complete naming rules, see [IDs, Paths, Strings, and Keywords](/document-model/fields#4Y_JMJedQeq0-0uDNcJcQ).
...
Each data type contains two distinct components: a merge behavior and a scalar value to store. (See [Data-Handling Essentials](<./../Data Store CRUD/Data Types.md>))
