...
- [Bluetooth Low Energy](/sync/concepts/transports-overview#gwI-u)
- [Apple Wireless Direct Link](/sync/concepts/transports-overview#3mnDB)
- [Wi-Fi Aware](/sync/concepts/transports-overview#x94k7)
- [Local Area Network](/sync/concepts/transports-overview#d7kjX)
