...
```
    ...
    <Frame>
        <img src="/images/best-practices/kotlin/jetpack-compose/vector-assets/add-vector-asset.png"/>
    </Frame>
    Click the "add" icon and select it for size \`24\`
    <Frame>
        <img src="/images/best-practices/kotlin/jetpack-compose/vector-assets/select-add-icon.png"/>
    </Frame>
...
<CardGroup>
    <Card>
    <Frame>
        ![](/images/best-practices/kotlin/jetpack-compose/vector-assets/circle-filled.png)
    </Frame>
    </Card>
    <Card>
    <Frame>
        ![](/images/best-practices/kotlin/jetpack-compose/vector-assets/circle-outline.png)
    </Frame>
    </Card>
</CardGroup>
