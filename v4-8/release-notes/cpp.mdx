...
<Icon icon="screwdriver-wrench"iconType="solid" horizontal />

**Fixed:** iOS devices may fail to sync on LAN when the app is backgrounded then foregrounded. (#14150)

## 4.8.1 Common Changes**

<Icon icon="plus"iconType="solid" horizontal />

Added:** The presence\_use\_multihop system parameter can be used to disable replicating presence information to other peers in the mesh, reducing network overhead. Use **ONLY** with guidance from the Ditto Customer Experience team. (#14128)
...
<Icon icon="star"iconType="solid" horizontal /> <Icon icon="plus"iconType="solid" horizontal />
