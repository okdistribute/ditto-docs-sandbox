...
<Steps>
  <Step>
   Confirm that you meet the minimum requirements. ([Prerequisites](https://docs.ditto.live/v4-8/install-guides/swift#HHTe7))
  </Step>
  <Step>
  Install the necessary dependencies. ([Installing Package Dependencies](https://docs.ditto.live/v4-8/install-guides/swift#g0ESg))
  </Step>
  <Step>
Set up your app permissions. ([Configuring Permissions](https://docs.ditto.live/v4-8/install-guides/swift#kX-Je))
  </Step>
  <Step>
[Authenticate with the Big Peer and then start syncing offline. ([Integrating and Initializing Sync](https://docs.ditto.live/v4-8/install-guides/swift#XNaBO))
  </Step>
...
<Tabs>
  <Tab title="Xcode">
    <Steps>
      ...
      - If building a production-level app, see [Developing for Production](https://docs.ditto.live/v4-8/install-guides/swift#BPHYO).
      - If testing Ditto with Apple Vision Pro devices, see [Exploring with visionOS beta](https://docs.ditto.live/v4-8/install-guides/swift#tMt7R).
      4. Click **Add Package**.

      <Frame>
        <img src="/images/v4.8/image-1.png"/>
      </Frame>
      ...
      <Frame>
        <img src="/images/v4.8/image-2.png"/>
      </Frame>
      </Step>
    </Steps>
...
<Frame>
        <img src="/images/v4.8/image-3.png"/>
</Frame>
</Step>
</Steps>
...
<Info>
For an overview of the Ditto SDK for visionOS, including steps outlining example integration with our demo chat app, [*DittoChat*](https://apps.apple.com/us/app/dittochat/id1450111256 "DittoChat"), see [visionOS on Swift](https://docs.ditto.live/v4-8/install-guides/#9eYfPNj_xG4j-R85evDAh).
</Info>
...
<Frame>
  <img src="/images/v4.8/image-4.png"/>
</Frame>
</Step>
</Steps>
...
Configure your project's Info.plist file to ensure the necessary permissions for Bluetooth Low Energy (LE) and local network services are included. ([Ensuring Privacy Compliance](https://docs.ditto.live/v4-8/install-guides/swift#aor0j))

</Step>

<Step>
If enabling the Data Protection entitlement, allow access after your end users have unlocked their device for the first time after a system restart. ([Setting Protection Entitlement](https://docs.ditto.live/v4-8/install-guides/swift#Fb7Ze))
</Step>
</Steps>
...
3. Right-click any row in the list, and then select **Add Row** from the menu.
  <Info>
For instructions on configuring permissions for your app, see [Cloud Authentication](https://docs.ditto.live/v4-8/auth-and-authorization/cloud-authentication).
</Info>

<Frame>
  <img src="/images/v4.8/image-5.png"/>
</Frame>
...
```
1<key\>NSBluetoothAlwaysUsageDescription</key\> 2<string\>Uses Bluetooth to connect and sync with nearby devices</string\> 3<key\>NSBluetoothPeripheralUsageDescription</key\> 4<string\>Uses Bluetooth to connect and sync with nearby devices</string\> 5<key\>NSLocalNetworkUsageDescription</key\> 6<string\>Uses WiFi to connect and sync with nearby devices</string\> 7<key\>NSBonjourServices</key\> 8<array\> 9 <string\>\_http-alt.\_tcp.</string\> 10</array\>
```
...
<Frame>
  <img src="/images/v4.8/image-6.png"/>
</Frame>
</Step>
</Steps>
...
For more information, see the official Apple documentation for [Data Protection Entitlement](https://developer.apple.com/documentation/bundleresources/entitlements/com_apple_developer_default-data-protection "Data Protection Entitlement").
...
For more information, contact Ditto. (See [Contact Us](https://docs.ditto.live/v4-8/install-guides/#n4CiVTbQAL1SmgjNO8aM8))
...
<Info>
For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](https://docs.ditto.live/v4-8/install-guides/#U214QhYYMCxbV9jnamRFH)
</Info>
