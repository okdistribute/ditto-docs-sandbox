...
- [Evict Method](https://docs.ditto.live/v4-8/crud/delete#-BLNB)
- [Coordinating Evictions](https://docs.ditto.live/v4-8/crud/delete#sODGf)
- [Soft-Delete Pattern](https://docs.ditto.live/v4-8/crud/delete#bPsqW)
- [Considerations](https://docs.ditto.live/v4-8/crud/delete#O9KV-)
...
For complete DQL syntax, see [EVICT](https://docs.ditto.live/v4-8/crud/#ksPbI9CsHPdud0iyuow9E).
