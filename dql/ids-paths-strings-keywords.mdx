...
| `MISSING`       | The path expression result is `MISSING` for the following conditions are both true:<br/><br/>* The leftmost name and all intermediate names are a `REGISTER` with JSON object type or a `MAP` type.<br/><br/>* The last name in the path does not exist. |
