...
Additionally, it offers support for various data types. For an overview of the data types you can use in Ditto, see the *Platform Manual *> [Data Structures and Types](/v4-4/data-structures-types).
...
For more information about Ditto documents, see *Platform Manual *> [Document Model](/document-model/fields).
