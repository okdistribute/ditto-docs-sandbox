...
Additionally, it offers support for various data types. For an overview of the data types you can use in Ditto, see the *Platform Manual *> [Data Structures and Types](/sdk/latest/data-types/register).
...
For more information about Ditto documents, see *Platform Manual *> [Document Model](/sdk/latest/document-model/fields).
