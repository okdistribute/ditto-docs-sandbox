...
[API Reference URL](https://software.ditto.live/android/Ditto/2.1.0/api-reference/)
...
- Added:
- Added: Updated permissions to request
- Changed: Improved error messages if concurrent Ditto instances attempt to use the same persistence directory

Installation:

> implementation "live.ditto:ditto:2.0.8"

[API Reference URL](https://software.ditto.live/android/Ditto/2.0.8/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.7/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.6/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.5/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.4/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.3/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.2/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.1/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.0/api-reference/)
...
[API Reference URL](https://software.ditto.live/android/Ditto/2.0.0-alpha1/api-reference/)
