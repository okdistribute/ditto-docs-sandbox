...
A production application must have robust auth system in place. Ditto lets you rebuild your Atlas Device Sync authentication and authorization flow in this document: [Migrating Authentication and Authorization from Atlas Device Sync to Ditto](<./Migrating Authentication and Authorization from Atlas Device Sync to Ditto.md>)
