...
If you need further assistance at any point, feel free to [reach out to our support team.](/support/contact-us)
...
Ditto lets your apps sync directly between :comment **clients** (Small Peers)** and a  **Big Peer (**<a href="/cloud/overview" target="_blank">**Cloud Platform**</a>**)** for real-time data sharing, with an offline-first design. This setup reduces the need for constant cloud access and improves performance.
...
Ditto is distributed by default, meaning it will automatically connect to, and sync data across your nearby devices. In order to solely rely on device-to-cloud sync, you can <a href="/sync/customizing-transport-configurations#disable-local-sync" target="_blank">disable local sync</a> by turning off LAN, peer-to-peer Wi-Fi, and Bluetooth transports.
...
We also recommend you make yourself familiar with [REGISTER](/sdk/latest/data-types/register), [MAP](/sdk/latest/data-types/map), and [ATTACHMENT](/sdk/latest/data-types/attachment) data types. Read more about best practices for data modelling with Ditto in [this guide](/best-practices/3-data-modeling-and-sync-logic).
...
- Need assistance? <a href="/support/contact-us" target="_blank">Reach out to us</a>!
