...
<Card title="JavaScript Web | Node.js | React Native" icon="square-3" href="/sdk/latest/install-guides/javascript#configure-permissions" iconType="solid" horizontal/>
