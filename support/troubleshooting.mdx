...
<Info>
    If you need technical support, submit a technical support request ticket. (See [Contact Us](<./../Contact Us.md>))
</Info>
...
**LOG\_LEVEL: Waiting for write transaction (elapsed: XXs), originator=User blocked\_by=User**
...
A long running write transaction might block an internal job. This scenario will be the least obvious to spot and it might not be obvious that it’s happening at all. It’s also the least likely to cause actual problems.[​](https://docs.ditto.live/ios/common/troubleshooting#user-deadlocks-user)
...
If you continue to have problems, please contact us via [Human Support](https://docs.ditto.live/support/troubleshooting#YXVys6OkQR6-OxSB3JXvC).
