...
| Authentication service    | Enables connected Small Peers to obtain valid certificates to participate in the mesh and replicate data they have permissions for. ([Authentication](/v4-6/security/authentication))                                                                     |
