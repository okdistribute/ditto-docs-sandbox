---
title: Ditto Forge
description: "Get started building apps with Ditto in minutes. Ditto Forge allows you to focus on what's unique to your business, while we take care of the rest."
icon: gauge
iconType: solid
---

<Warning>
Ditto Forge for iOS is currently in private preview and is likely to evolve further, prior to its full release.

You can sign up for the [Ditto Forge](https://ditto.live/platform/mongodb-connector) waitlist to request access to the preview!
</Warning>

Ditto Forge defines the structure of your app, organizing Ditto objects such as
...
<Step>
Open the Ditto database that you want to use with Forge.
</Step>
<Step>
Click “App Builder ↗️” on the top-right of the screen.
</Step>
<Step>
Join the <a href="https://testflight.apple.com/join/Hmk6Cat9" target="_blank">Apple TestFlight Beta Group</a> and install the iOS app. 
</Step>
<Step>
Ensure your device is iOS 16.0+ or higher and you have WiFi enabled. 
</Step>
<Step>
In the iOS app, click “Scan” at the bottom and scan the QR Code in the portal.
</Step>
</Steps>

You now have created your first Ditto Forge application.

## Data

In the Data tab, you define the data schema of your enterprise records. Forge
enables relational database management, using a schema-based model that allows
both unstructured and structured data to coexist. Data in your Ditto database
that does not conform to your structured schema will not appear in Forge apps.
...
in the Ditto Forge app.</Warning>
...
<Warning>
Forge only supports one-to-one and one-to-many relationships today. Many-to-many relationships will be supported in the future.
</Warning>
...
Open DQL Editor and issue the following commands one by one in the editor. Each command should be issued separately, since DQL does not support multi-line queries
