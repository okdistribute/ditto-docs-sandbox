...
Learn how to build a task list app built on .NET Maui and integrated with Ditto by going to the [MAUI Task App](/best-practices/how-to/c-sharp/maui-task-app) how-to tutorial.
