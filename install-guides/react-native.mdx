...
<Step>
If desired, enable the Small Peer Information feature. ([Enabling smallPeerInfo](#enabling-small-peer-info))
</Step>
...
<Step>
Create your subscription logic. ([Constructing Subscription Logic](/install-guides/react-native#XlY3i))
</Step>
</Steps>
