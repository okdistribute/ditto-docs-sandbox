...
<Steps>
  <Step>
   Confirm that you meet the minimum requirements. ([Prerequisites](install-guides/swift#HHTe7))
  </Step>
  <Step>
  Install the necessary dependencies. ([Installing Package Dependencies](install-guides/swift#g0ESg))
  </Step>
  <Step>
Set up your app permissions. ([Configuring Permissions](install-guides/swift#kX-Je))
  </Step>
  <Step>
[Authenticate with the Big Peer and then start syncing offline. ([Integrating and Initializing Sync](install-guides/swift#XNaBO))
  </Step>
...
<Tabs>
  <Tab title="Xcode">
    <Steps>
      ...
      - If building a production-level app, see [Developing for Production](install-guides/swift#BPHYO).
      - If testing Ditto with Apple Vision Pro devices, see [Exploring with visionOS beta](install-guides/swift#tMt7R).
      4. Click **Add Package**.
...
For more information, contact Ditto. (See [Contact Us](install-guides/#n4CiVTbQAL1SmgjNO8aM8))
...
<Info>
For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](install-guides/#U214QhYYMCxbV9jnamRFH)
</Info>
