...
<Steps>
  <Step>
    [Prerequisites](/install-guides/js#sb-Fz): Confirm that you meet the minimum requirements.
  </Step>
  <Step>
 [Install Dependencies](/install-guides/js#i_i6q): Add the ditto package to your environment.
  </Step>
  <Step>
[Integrate Ditto](/install-guides/js#Ajrfc): Import and initialize Ditto in your app.
  </Step>
  <Step>
[Run Ditto](/install-guides/js#s71_W): Authenticate with the Big Peer and start syncing offline.
  </Step>
