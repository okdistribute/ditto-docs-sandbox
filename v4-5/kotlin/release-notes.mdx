---
title : "Release Notes: Kotlin v4.5"
---

# Kotlin Version 4.5.4
**Fixed**
...
# Kotlin Version 4.5.3**Fix**

- A crash in Android bluetooth subsystem (#11467)

# Kotlin Version 4.5.2**Added**
...
# Kotlin Version 4.5.0If you are upgrading from v4.x to v4.5 without adopting any new functionality there will be no changes required and all other v4.x devices will sync with v4.5 devices.
...
If you plan on adopting DQL as part of the migration to v4.5 review [Legacy-to-DQL Adoption Guide](https://docs.ditto.live/v4-5/kotlin/#e2ZbKPkQwYMyXW5pN4rjM)﻿﻿
