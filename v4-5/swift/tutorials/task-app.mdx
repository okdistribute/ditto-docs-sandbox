...
1. [Creating a New App in Xcode](/v4-5/swift/tutorials/task-app#mhEfg)
2. [Adding Permissions to the Info.plist](/v4-5/swift/tutorials/task-app#LzNMr)
3. [Creating UI Elements](/v4-5/swift/tutorials/task-app#C9qeV)
4. [Configuring the Storyboard](/v4-5/swift/tutorials/task-app#X222X)
5. [Connecting the UI](/v4-5/swift/tutorials/task-app#Lftr6)
6. [Setting Up the TasksTableViewController](/v4-5/swift/tutorials/task-app#CUJ0a)
7. [Adding a Task](/v4-5/swift/tutorials/task-app#3Rg5z)
8. [Configuring the UITableView to Display Task List](/v4-5/swift/tutorials/task-app#RxDM-)
9. [Editing Tasks](/v4-5/swift/tutorials/task-app#1nsVj)
