...
# Creating a Memory Leak with Combine[​](https://legacydocs.ditto.live/ios/quick-tips/prevent-accumulating-publishers#creating-a-memory-leak-with-combine)
...
# A Hacky Fix[​](https://legacydocs.ditto.live/ios/quick-tips/prevent-accumulating-publishers#a-hacky-fix)
...
## The Preferred Approach[​](https://legacydocs.ditto.live/ios/quick-tips/prevent-accumulating-publishers#the-good-way)
