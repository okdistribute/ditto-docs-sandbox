...
- [Evict Method](/v4-5/crud-delete#evicting-data)
- [Coordinating Evictions](/v4-5/crud-delete#coordinating-evictions)
- [Soft-Delete Pattern](/v4-5/crud-delete#soft-delete-pattern)
- [Considerations](/v4-5/crud-delete#considerations)
...
For complete DQL syntax, see [EVICT](/v4-5/crud-delete#evicting-data).
