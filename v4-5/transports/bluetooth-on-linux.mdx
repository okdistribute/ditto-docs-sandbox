...
```
Your Linux system is now ready to install and run Ditto. For instructions on how to install and set up Ditto, see [SDK Setup Guides](#Cv1W3s78ql3FV94bNGXW3).
