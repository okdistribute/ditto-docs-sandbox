...
- A [shared key.](https://legacydocs.ditto.live/csharp/common/security/shared-key)
...
<a href="https://github.com/getditto/samples/tree/master/c-sharp-server" target="_blank">See the full code in the Samples Repository</a>
