...
- [Default Ditto Behavior](/4.7/sync/managing-redundant-bluetooth-le-connections#U1QPf)
- [Considerations by Mesh Size](/4.7/sync/managing-redundant-bluetooth-le-connections#yq6el)
- [Enabling Redundant Connections](/4.7/sync/managing-redundant-bluetooth-le-connections#R46YK)
