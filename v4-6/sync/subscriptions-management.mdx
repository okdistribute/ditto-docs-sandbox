...
- To get your active `subscriptions`, call the subscriptions method on the `ditto.sync` namespace. ([Retrieving Subscriptions](https://docs.ditto.live/v4-6/sync/subscriptions-management#J8rYE)﻿)
- To cancel a subscription, call `cancel` on its subscription object you instantiated when setting up your subscription. ([Canceling Subscriptions](https://docs.ditto.live/v4-6/sync/subscriptions-management#aVT0-)﻿)
- To confirm cancelation, call the i`sCancelled` field on the subscription object. ([Canceling Subscriptions](https://docs.ditto.live/v4-6/sync/subscriptions-management#aVT0-)﻿)
