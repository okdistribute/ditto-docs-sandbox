...
1. Before calling `startSync()`, create a `DittoTransportConfig` object with the desired settings.


2. Using the `ditto.SetTransportConfig` API method, set the created object on your Ditto instance.


3. Call the `startSync` method on your Ditto instance to initiate sync with the configured settings.
