...
<Steps>
  <Step>
   Confirm that you meet the minimum requirements. ([Prerequisites](/v4-6/ios/installation#HHTe7))
  </Step>
  <Step>
  Install the necessary dependencies. ([Installing Package Dependencies](/v4-6/install-guides/swift#g0ESg))
  </Step>
  <Step>
Set up your app permissions. ([Configuring Permissions](/v4-6/install-guides/swift#kX-Je))
  </Step>
  <Step>
[Authenticate with the Big Peer and then start syncing offline. ([Integrating and Initializing Sync](/v4-6/install-guides/swift#XNaBO))
  </Step>
...
<Tabs>
  <Tab title="Xcode">
    <Steps>
      ...
      - If building a production-level app, see [Developing for Production](/v4-6/install-guides/swift#BPHYO).
      - If testing Ditto with Apple Vision Pro devices, see [Exploring with visionOS beta](/v4-6/install-guides/swift#tMt7R).
      4. Click **Add Package**.
      ...
      <Frame>
        <img src="/images/v4.6/image-2.png"/>
      </Frame>
      </Step>
    </Steps>
...
<Frame>
  <img src="/images/v4.6/image-3.png"/>
</Frame>
</Step>
</Steps>
...
<Info>
For an overview of the Ditto SDK for visionOS, including steps outlining example integration with our demo chat app, [*DittoChat*](https://apps.apple.com/us/app/dittochat/id1450111256 "DittoChat"), see [visionOS on Swift](/v4-6/install-guides/#9eYfPNj_xG4j-R85evDAh).
</Info>
...
<Frame>
  <img src="/images/v4.6/image-4.png"/>
</Frame>
</Step>
</Steps>
...
Configure your project's Info.plist file to ensure the necessary permissions for Bluetooth Low Energy (LE) and local network services are included. ([Ensuring Privacy Compliance](/v4-6/install-guides/swift#aor0j))
</Step>

<Step>
If enabling the Data Protection entitlement, allow access after your end users have unlocked their device for the first time after a system restart. ([Setting Protection Entitlement](/v4-6/install-guides/swift#Fb7Ze))
</Step>
</Steps>
...
<Info>
For instructions on configuring permissions for your app, see [Cloud Authentication](/v4-6/auth-and-authorization/cloud-authentication).
</Info>

<Frame>
  <img src="/images/v4.6/image-5.png"/>
</Frame>
...
<Frame>
  <img src="/images/v4.6/image-6.png"/>
</Frame>
</Step>
</Steps>
...
For more information, contact Ditto. (See [Contact Us](/v4-6/install-guides/#n4CiVTbQAL1SmgjNO8aM8))
...
For instructions on how to obtain your access credentials, see [Getting Playground Token Credentials](/v4-6/install-guides/#U214QhYYMCxbV9jnamRFH)
</Warning>
```swift Swift
