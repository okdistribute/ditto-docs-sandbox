...
<Steps>
<Step>
Confirm that you meet the minimum requirements. ([Prerequisites](/v4-6/get-started/install-guides/c-sharp#Vh6Ct))
</Step>
<Step>
Install the Ditto SDK. ([Installing Dependencies](/v4-6/get-started/install-guides/c-sharp#cxPSx))
</Step>
<Step>
Set up your app permissions. ([Configuring Permissions](/v4-6/get-started/install-guides/c-sharp#0pCl9))
</Step>
<Step>
Add Ditto to your app. ([Initializing Ditto](/v4-6/get-started/install-guides/c-sharp#J-rzQ))
</Step>
</Steps>
