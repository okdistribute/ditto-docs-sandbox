...
For an example demonstrating both the deeply embedded and flat models, see [Bad Pattern: Large Documents](/vv4-6/document-model/relationships#B4Bj0z0xxoHo2KD13tYSL).
