...
For complete naming rules, see [IDs, Paths, Strings, and Keywords](/v4-6/document-model/fields#4Y_JMJedQeq0-0uDNcJcQ).
...
Each data type contains two distinct components: a merge behavior and a scalar value to store. (See [Data-Handling Essentials](/v4-6/document-model/fields#Z6tbFllqieU_CtkJR845E))
...
<Frame>
  <img src="/images/v4.6/doc-model.webp"/>
</Frame>
