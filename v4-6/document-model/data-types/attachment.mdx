...
You can create and transmit attachments across peers, even with intermittent connectivity; however, unlike documents, which are always accessible and automatically sync when relevant per sync subscriptions, peers do not automatically fetch the attachment data associated
...
<Frame>
    <img src="/images/v4.6/datatype-1.webp"/>
</Frame>
