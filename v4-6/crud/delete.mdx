...
- [Evict Method](/v4-6/crud/delete#-BLNB)
- [Coordinating Evictions](/v4-6/crud/delete#sODGf)
- [Soft-Delete Pattern](/v4-6/crud/delete#bPsqW)
- [Considerations](/v4-6/crud/delete#O9KV-)
...
For complete DQL syntax, see [EVICT](/v4-6/crud/#ksPbI9CsHPdud0iyuow9E).
