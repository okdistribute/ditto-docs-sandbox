...
<Frame>
  <img src="/images/v4.6/release-8.webp"/>
</Frame>
...
<Accordion title="Additional Changes"> - Fixed: Exported function for the React Native SDK. - Fixed: Memory management bug in the React Native SDK. - Fixed: Potential overflow in DQL API not using [appropriate API]. </Accordion>
